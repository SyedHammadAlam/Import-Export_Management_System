					...
					while (1) {
						...
						if (input2 == 2)
						{
							if (i >= 1) {
								...
								for (int x = 0; x < i; x++)
								{
									if (sender[x].getname() == input1)
									{
										system("cls");
										cout << "\n-----------------------------------------|DETAILS|--------------------------------------\n\n";
										cout << "\n\n--------------------------------------|Sender DETAILS|----------------------------------\n\n";
										cout << "\nSender name: " << sender[x].getname();
										cout << "\nSender Country: " << sender[x].getcountry();
										cout << "\nSender Company Name: " << sender[x].getcompanyname();
										cout << "\n\n-------------------------------------|RECEIVER DETAILS|----------------------------------\n\n";
										cout << "\nReceiver name: " << receiver[x].getname();
										cout << "\nReceiver Country: " << receiver[x].getcountry();
										cout << "\nReceiver Company Name: " << receiver[x].getcompanyname();
										cout << "\n\n-------------------------------------|SHIPMENT DETAILS|----------------------------------\n\n";
										cout << "\nShipment Product Weight: " << shipment[x].getweight() << " kgs";
										cout << "\nShipment Product Quantity: " << shipment[x].getquantity();
										cout << "\nShipment Product Date Of Ordering: " << shipment[x].getdate();
										cout << "\nShipment Product Time OF Ordering: " << shipment[x].gettimeoforder();
										cout << "\nShipment Product Expected Date Of Reaching: " << shipment[x].gettimeofreachexpected();
										cout << "\nShipment Product Price:  " << shipment[x].getprice() << " Dollars";
										cout << "\n\n-------------------------------------|TRANSPORT DETAILS|----------------------------------\n\n";
										cout << "\nTransport Type: " << transport[x].getShipmentType();
										cout << "\nTransport Price: " << transport[x].getTansportCharges();
										while (1) {
											cout << "\nDo you want to check delivery status(1 = yes): ";
											cin >> input2;
											if (input2 == 1)
											{
												transport[x].CheckDeliveryStatus();
											}
											else
											{
												break;
										...
										cout << "\n\n-------------------------------------|PAYMENT DETAILS|----------------------------------\n\n";
										cout << "\nPAYMENT METHOD: " << payment[x].getPaymentmethod();
										cout << "\nTOTAL PAYMENT: " << payment[x].gettotalpayment();
										cout << "\nGIVEN PAYMENT: " << payment[x].getgivenpayment();
										cout << "\nREMAINING PAYMENT: " << payment[x].getRemainingpayment();
									}
								}
							}
							else
